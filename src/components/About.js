    ...
    <div className='bg-dark text-white mt-4 '>
      <Container>
        <Row className='align-items-center'>
          <Col>
            <img src='./images/about-img.png' alt='' className='img-fluid ms-auto d-block '></img>
          </Col>
          <Col>
            <h1 style={{ fontFamily: "Monotype Corsiva" }}>We Are Feane</h1>
            ...
            <Button variant="warning" className='text-white fs-5 px-4 rounded-pill mt-4 mb-5'>Read More</Button>{' '}
          </Col>
        </Row>
      </Container>
